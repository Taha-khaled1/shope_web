                                ...
                                <div class="tab-content">
                                    <div class="tab-pane p-3 active" id="Post" role="tabpanel">
                                      ...
                                      <input   type="text" name="id" value="{{$product->id}}"  style="display:none;">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <small class="form-text text-danger">{{$message}}</small>
                                            @enderror
                                                <input class="form-control" name="code" id="code" type="text"  maxlength="100" value="{{$product->code}} "  >
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <table >@foreach($product->option as $a)
                                                            <tr class="R_optin{{$a->id}}">
                                                                    <td  > الملحق: </td> 
                                                                    <td  >   {{$a->name}}</td>
                                                                    <td  > &nbsp;&nbsp;السعر: </td> 
                                                                    <td  > {{$a->price}}</td> 
                                                                    <td> <span> <a href="#!" class="deleteoption" deleteoptin="{{$a->id}}"> &nbsp;&nbsp;&nbsp;ازالة الملحق </a></span></td>
