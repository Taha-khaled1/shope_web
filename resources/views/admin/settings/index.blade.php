                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label text-end">   العنوان</label>
                                            <div class="col-sm-9">
                                                <input class="form-control" name="section1_header" type="text" value="{{$setting['section1_header']}}" id="example-text-input">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label text-end">   النص</label>
                                            <div class="col-sm-9">
                                            <textarea class="form-control" name="section2_header" rows="6" maxlength="500" >{{$setting['section2_header']}}</textarea>                                      

                                             </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label text-end">   رابط عرض المزيد</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <img src="{{asset('/storage/users/'.$setting['section1_image'])}}" alt="header_logo"  width="100">
                                            @endif
                                            </div>
                                        </div>
                                       
                                        <div class="mb-3 row">
                                            <label   class="col-sm-3 col-form-label text-end">تغيير الصورة</label>
                                            <div class="col-sm-9">
                          ...
                          <hr>
                                       ...
                                       <div class="mb-1 row">
                                        ...
                                        <div class="mb-1 row">
                                            <h3>الشروط والاحكام باللغة الانجليزية </h3>
                                            <div class="col-sm-12">
